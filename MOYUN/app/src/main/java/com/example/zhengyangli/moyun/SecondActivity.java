...
//    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        Toast.makeText(SecondActivity.this,"HELLOW WORLD", Toast.LENGTH_LONG);
        ...
        mWebView.loadUrl("assets/main.html");
    }
    ...
    class myHellowWorld{
        ...
        public void show(){
            mHandler.post(new Runnable(){
                ...
                @Override
                public void run() {
                    Toast.makeText(SecondActivity.this,"HELLOW WORLD", Toast.LENGTH_LONG).show();
                }
            });
        }
    }
